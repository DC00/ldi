  ...
  inherits IO { -- inheriting from IO allows us to read and write strings
	...
	main() : Object { -- this method is invoked when the program starts
             let 
                 ...
                 removed : List <- new Nil, -- after removal
                 string_to_remove : String <- "dairy", 
             ...
             in {
               ...
               l.print_list () ;
               out_string("---\n"); 
               removed <- l.remove(string_to_remove ) ;
               removed.print_list () ; -- print out the result
             }
	};
};
	...
	print_list() : Object {
        ...
        remove(string_to_remove : String) : List { 
                if string_to_remove = xcar then
                  ...
                  (new Cons).init(xcar, xcdr.remove(string_to_remove))
                fi 
        }; 
} ;
...
Class Nil inherits List { -- Nil is an empty list 
    ...
    remove(string_to_remove : String) : List { new Nil } ;
